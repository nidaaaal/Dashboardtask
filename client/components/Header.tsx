          ...
          <button className="p-2 hover:bg-muted rounded-lg transition-colors">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5A2.25 2.25 0 008.25 22.5h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0a.75.75 0 00-.75.75v.75h3v-.75a.75.75 0 00-.75-.75m0 0H9.75"
              />
            </svg>
          </button>
          <button className="p-2 hover:bg-muted rounded-lg transition-colors">
